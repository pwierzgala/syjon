...
from apps.merovingian.forms.reform_2011.forms import *
...
TEMPLATE_ROOT = "merovingian/modules/reform_2011"


def list_2011(request, sgroup):
...
def edit_2011(request, module):
    ...
    if request.method == 'POST':
        ...
        subject_formset = SubjectInlineFormset(request.POST, instance=module)
...
def syllabuses_2011(request, module):
    sgroup = module.sgroup
