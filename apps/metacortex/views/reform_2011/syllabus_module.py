...
from apps.metacortex.forms.reform_2011.forms import SyllabusModuleForm
from apps.syjon.lib.functions import utf2ascii
from apps.syjon.lib.pdf import render_to_pdf

TEMPLATE_ROOT = 'metacortex/syllabus_my/reform_2011/module/'


def syllabus_module_edit_2011(request, syllabus):
...
def syllabus_module_show_2011(request, syllabus):
    context = {'syllabus': syllabus}
    template_path = os.path.join(TEMPLATE_ROOT, 'show.html')
    return render(request, template_path, context)


def syllabus_module_print_2011(request, syllabus):
