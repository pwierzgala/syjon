...
TEMPLATE_ROOT = 'trinity/mlo/reform_2019'


def select_module_2019(request, course, sgroup):
...
def show_2019(request, course, sgroup, module):
...
def add_2019(request, course, sgroup, module):
...
def update_2019(request, course, sgroup, module, mlo):
    course_learning_outcomes = CourseLearningOutcome.objects.filter(course=course)
    form = ModuleLearningOutcomeForm(
        request.POST or None,
        queryset=course_learning_outcomes,
...
def print_pdf_2019(request, course, sgroup, module):
